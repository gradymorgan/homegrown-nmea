...
describe('coordinates', function() {
    it(' should be parsed', function() {
        assert.closeTo( nmea.coordinate.parse(4740.2949,'N'), 47.6715816, 0.000001 );
        assert.closeTo( nmea.coordinate.parse(12228.5660,'W'), -122.4761, 0.000001 );
        //TODO: E & S & 0.0?
    });
...
describe('parsers', function() {
    ...
    describe('RMC', function() {
        it('should parse', function() {
            ...
            assert.closeTo(data.lat, expected.lat, 0.00001);
            assert.closeTo(data.lon, expected.lon, 0.00001);
